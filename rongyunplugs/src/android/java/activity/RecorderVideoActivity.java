...
public class RecorderVideoActivity extends FragmentActivity implements SurfaceHolder.Callback, MediaRecorder.OnErrorListener,
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(ResourcesUtils.getLayoutId(this,"em_recorder_activity"));
  ...
  private void initViews() {
    btn_switch = (Button) findViewById(ResourcesUtils.getId(this,"switch_btn"));
    ...
    mVideoView = (VideoView) findViewById(ResourcesUtils.getId(this,"mVideoView"));
    btnStart = (ImageView) findViewById(ResourcesUtils.getId(this,"recorder_start"));
    btnStop = (ImageView) findViewById(ResourcesUtils.getId(this,"recorder_stop"));
    ...
    btnStop.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        new AlertDialog.Builder(RecorderVideoActivity.this)
          .setMessage(ResourcesUtils.getStringId(RecorderVideoActivity.this,"Whether_to_send"))
          .setPositiveButton(ResourcesUtils.getStringId(RecorderVideoActivity.this,"ok"),
          ...
          .setNegativeButton(ResourcesUtils.getStringId(RecorderVideoActivity.this,"cancel"),
            new DialogInterface.OnClickListener() {
    ...
    chronometer = (Chronometer) findViewById(ResourcesUtils.getId(this,"chronometer"));
  }
  ...
  public void onInfo(MediaRecorder mr, int what, int extra) {
    ...
    if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
      ...
      String st3 = getResources().getString(ResourcesUtils.getStringId(this,"Whether_to_send"));
      new AlertDialog.Builder(this)
        .setMessage(st3)
        .setPositiveButton(ResourcesUtils.getStringId(this,"ok"),
          new DialogInterface.OnClickListener() {
          ...
          }).setNegativeButton(ResourcesUtils.getStringId(this,"cancel"), null)
        .setCancelable(false).show();
    }
  ...
  private void showFailDialog() {
    new AlertDialog.Builder(this)
      .setTitle(ResourcesUtils.getStringId(this,"prompt"))
      .setMessage(ResourcesUtils.getStringId(this,"Open_the_equipment_failure"))
      .setPositiveButton(ResourcesUtils.getStringId(this,"ok"),
        new DialogInterface.OnClickListener() {
