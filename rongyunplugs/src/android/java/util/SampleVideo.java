package cordova.plugin.ismartnet.rongcloud.video.util;
...
public class SampleVideo extends StandardGSYVideoPlayer {
  ...
  private void initView() {
    mMoreScale = (TextView) findViewById(ResourcesUtils.getId(getActivityContext(),"moreScale"));
    mSwitchSize = (TextView) findViewById(ResourcesUtils.getId(getActivityContext(),"switchSize"));
    mChangeRotate = (TextView) findViewById(ResourcesUtils.getId(getActivityContext(),"change_rotate"));
    mChangeTransform = (TextView) findViewById(ResourcesUtils.getId(getActivityContext(),"change_transform"));
  ...
  public int getLayoutId() {
    return  ResourcesUtils.getLayoutId(getActivityContext(),"sample_video");
